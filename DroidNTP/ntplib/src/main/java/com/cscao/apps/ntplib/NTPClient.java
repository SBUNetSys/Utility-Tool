...
public final class NTPClient {
    ...
    public NTPClient() {
        this(Constants.DEFAULT_SERVER, Constants.DEFAULT_TIMEOUT);
    }

    public NTPClient(String server) {
        this(server, Constants.DEFAULT_TIMEOUT);
    }

    public NTPClient(String server, int timeout) {
        this.server = server;
...
//                + " seconds" + " (2 ** " + poll + ")");
        ...
        details += " poll: " + (poll <= 0 ? 1 : (int) Math.pow(2, poll))
                + " seconds" + " (2 ** " + poll + ")" + "\n";
...
//        System.out.println(" Reference Timestamp:\t" + refNtpTime + "  " + refNtpTime.toDateString());
        ...
        details += " Reference Timestamp:\t" + refNtpTime
...
//        System.out.println(" Originate Timestamp:\t" + origNtpTime + "  " + origNtpTime.toDateString());
        ...
        details += " Originate Timestamp:\t" + origNtpTime
...
//        System.out.println(" Receive Timestamp:\t" + rcvNtpTime + "  " + rcvNtpTime.toDateString());
        ...
        details +=" Receive Timestamp:\t" + rcvNtpTime
...
//        System.out.println(" Transmit Timestamp:\t" + xmitNtpTime + "  " + xmitNtpTime.toDateString());
        ...
        details +=" Transmit Timestamp:\t" + xmitNtpTime
...
//        System.out.println(" Destination Timestamp:\t" + destNtpTime + "  " + destNtpTime.toDateString());
        ...
        details +=" Destination Timestamp:\t" + destNtpTime
...
//                + ", clock offset(ms)=" + offset); // offset in ms
        details +=" Roundtrip delay(ms)=" + delay
...
//                        + hostAddr.getHostAddress());
                details += "NTP server: " + hostAddr.getHostName() + "/"
                        + hostAddr.getHostAddress();
    ...
    public long getOffset() {
        TimeInfo info = requestTime(server, timeout);
